...
<h1>PRODUCT PEGADAIAN</h1>
<div class="tab_container">
    <input id="tab1" type="radio" name="tabs" checked>
    <label for="tab1"><i class="fa fa-solid fa-hand-holding-dollar"></i><span>PINJAMAN GADAI</span></label>

    <input id="tab2" type="radio" name="tabs">
    <label for="tab2"><i class="fa fa-sharp fa-solid fa-sack-xmark"></i><span>PINJAMAN NON GADAI</span></label>

    <input id="tab3" type="radio" name="tabs">
    <label for="tab3"><i class="fa fa-users-line"></i><span>LAYANAN JASA</span></label>
    ...
    <div class="container m-5 ">
        <div class="row gap-1 ">
            ...
            <div class="card" style="width: 15rem;">
                ...
                <img src="img/KURSYARIAH.JPG" class="card-img-top mt-3" alt="..."></a></p>
                <div class="card-body text-center">
    ...
    <section id="content3" class="tab-content">
            ...
            <div class="card" style="width: 15rem;">
                ...
                <img src="img/pengiriman-uang.png" class="card-img-top mt-3" alt="..."></a></p>
                <div class="card-body text-center">
            ...
            <div class="card" style="width: 15rem;">
                ...
                <img src="img/pengiriman-uang (1).png" class="card-img-top mt-3" alt="..."></a></p>
                <div class="card-body text-center">
            ...
            <div class="card" style="width: 15rem;">
                ...
                <img src="img/jasa-sertifikasi.png" class="card-img-top mt-3" alt="..."></a></p>
                <div class="card-body text-center">
            ...
            <div class="card" style="width: 15rem;">
                ...
                <img src="img/jasa-taksiran.png" class="card-img-top mt-3" alt="..."></a></p>
                <div class="card-body text-center">
                    <h5>Jasa Taksiran</h5>
            ...
            <div class="card" style="width: 15rem;">
                ...
                <img src="img/gadai-titipan-emas-produk (1).png" class="card-img-top mt-3" alt="..."></a></p>
                <div class="card-body text-center">
                    <h5>Jasa Titipan</h5>
            ...
            <div class="card" style="width: 15rem;">
                ...
                <img src="img/safe-deposit-box.png" class="card-img-top mt-3" alt="..."></a></p>
                <div class="card-body text-center">
...
<p class="link">
    Just in case you want to go through the tutorial follow this link: <a
        href="http://www.sevensignature.com/blog/code/responsive-pure-css-tabs/">Responsive Pure CSS Tabs</a>
</p>



{{-- End Product Pegadaian --}}
